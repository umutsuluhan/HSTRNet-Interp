...
class FusionNet(nn.Module):
    ...
    def forward(self, img0_HR, img1_HR, img0_LR, img1_LR, img2_LR, flow_HR, flow_LR_0_1, flow_LR_2_1, c0_HR, c1_HR):
        warped_img0_HR = warp(img0_HR, flow_HR[:, :2])            # I0 = (I0, Ft-->0)
        warped_img1_HR = warp(img1_HR, flow_HR[:, 2:4])           # I1 = (I1, Ft-->1)

        # Check below again and ask to Prof. Which one?
        warped_img0_LR = warp(img0_LR, flow_LR_0_1)
        warped_img2_LR = warp(img2_LR, flow_LR_2_1)
        
        # warped_img0_LR = warp(img1_LR, flow_LR_0_1)
        # warped_img2_LR = warp(img1_LR, flow_LR_2_1)
        
        # Warping in Super Slomo and RIFE looks different. For RIFE intermediate flows are needed, however Super Slomo can use direct flows.
