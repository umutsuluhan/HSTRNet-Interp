...
class FusionNet(nn.Module):
    ...
    def forward(self, img0_HR, img1_HR, img0_LR, img2_LR, img1_LR, flow_HR, flow_LR, c0_HR, c1_HR, c0_LR, c1_LR):
        ...
        s0 = self.down0(torch.cat((warped_img0_HR, warped_img1_HR, warped_img0_LR, warped_img2_LR, img1_LR), 1))
        s1 = self.down1(torch.cat((s0, c0_HR[0], c1_HR[0], c0_LR[0], c1_LR[0]), 1))
        s2 = self.down2(torch.cat((s1, c0_HR[1], c1_HR[1], c0_LR[1], c1_LR[1]), 1))
        s3 = self.down3(torch.cat((s2, c0_HR[2], c1_HR[2], c0_LR[2], c1_LR[2]), 1))
        x = self.up0(torch.cat((s3, c0_HR[3], c1_HR[3], c0_LR[3], c1_LR[3]), 1))
...
class Model:
    ...
    def predict(self, imgs_HR, imgs_LR, flow_HR, flow_LR, training=True):
        ...
        if training:
            return pred, mask, warped_img0_HR, warped_img1_HR, warped_img0_LR, warped_img2_LR,
        else:
            return pred

    def inference(self, imgs, scale=None):
        imgs_HR = imgs[:, :6]                # Concatenation of img0_HR and img1_HR respectively.
        imgs_LR = imgs[:, 6:12]              # Concatenation of img0_LR and img2_LR respectively. 
...
if __name__ == '__main__':
    img0_HR = cv2.imread("/home/hus/Desktop/repos/HSTRNet/images/original_vid/0.png")
    img1_HR = cv2.imread("/home/hus/Desktop/repos/HSTRNet/images/original_vid/1.png")
    
    img0_LR = cv2.imread("/home/hus/Desktop/repos/HSTRNet/images/2X_vid/0000000.png")
    img1_LR = cv2.imread("/home/hus/Desktop/repos/HSTRNet/images/2X_vid/0000001.png")
    img2_LR = cv2.imread("/home/hus/Desktop/repos/HSTRNet/images/2X_vid/0000002.png")
