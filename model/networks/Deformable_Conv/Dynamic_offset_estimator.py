...
from .Model_utils import DOE_downsample_block, DOE_upsample_block
...
class Dynamic_offset_estimator(nn.Module):
    ...
    def forward(self,x):
        ...
        if(quarterscale_NLout.shape[2] != quarterscale_feature.shape[2]):
            quarterscale_NLout = quarterscale_NLout[:, :, :(quarterscale_NLout.shape[2] - quarterscale_feature.shape[2]), :]
        if(quarterscale_NLout.shape[3] != quarterscale_feature.shape[3]):
            quarterscale_NLout = quarterscale_NLout[:, :, :, :(quarterscale_NLout.shape[3] - quarterscale_feature.shape[3])]
